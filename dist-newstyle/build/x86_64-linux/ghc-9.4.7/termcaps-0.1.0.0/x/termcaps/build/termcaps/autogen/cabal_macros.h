...
/* package termcaps-0.1.0.0 */
#ifndef VERSION_termcaps
#define VERSION_termcaps "0.1.0.0"
#endif /* VERSION_termcaps */
#ifndef MIN_VERSION_termcaps
#define MIN_VERSION_termcaps(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_termcaps */
...
#define CURRENT_COMPONENT_ID "termcaps-0.1.0.0-inplace-termcaps"
